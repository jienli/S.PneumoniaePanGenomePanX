...
var blast = {};
exports.default = blast;


_parser2.default.mixin(blast);
...
blast.parse = function (str) {
  ...
  doc.eachChild(function (child, index) {
    ...
    switch (name) {
      ...
      case "param":
        ...
        _helper2.default.addAttr(child, res[name]);
        break;
      case "Header":
        // EBI parameters
        customFormat = "EBI";
        ...
        if (parametersChild != undefined) {
          ...
          header.param.databases = parseArray(databases, _helper2.default.addAttr);
          ...
          header.param.sequences = parseArray(sequences, _helper2.default.addAttr);
        }
        // convert the header
        ...
        _helper2.default.renameParams(header.param, remapParams);
  ...
  if (!!res.param) {
    _helper2.default.checkIntProps(res.param, paramsIntKeys);
  }
  ...
  node.eachChild(function (child, index) {
    ...
    if (child.children.length === 0) {
      ...
      if (Object.keys(child.attr).length > 0) {
        ...
        _helper2.default.addAttr(child, obj[name]);
      }
    }
  });
  return obj;
...
function parseHit(node) {
  ...
  if (childNode == undefined) {
    ...
    _helper2.default.addAttr(node, obj);
    _helper2.default.renameProperty(obj, "length", "len");
    _helper2.default.renameProperty(obj, "ac", "accession");
    _helper2.default.renameProperty(obj, "number", "num");
    delete obj.length;
  }
  obj.hsps = parseArray(childNode, parseHSP);
  _helper2.default.checkIntProps(obj, hitIntKeys);
  return obj;
}

var hsspIntKeys = ["num", "score", "query-from", "query-to", "hit-from", "hit-to", "query-frame", "hit-frame", "align-len", "identitiy", "positive", "gaps"];
...
function parseHSP(node) {
  ...
  // rename EBI params
  _helper2.default.renameProperty(obj, "expectation", "evalue");
  _helper2.default.renameProperty(obj, "bits", "bit-score");
  _helper2.default.renameProperty(obj, "querySeq", "qseq");
  _helper2.default.renameProperty(obj, "matchSeq", "hseq");
  _helper2.default.renameProperty(obj, "pattern", "midline");
  if (obj["align-len"] == undefined) {
    obj["align-len"] = obj["qseq"].length;
  }
  _helper2.default.checkIntProps(obj, hsspIntKeys);
  _helper2.default.checkFloatProps(obj, hsspFloatKeys);
  return obj;
}